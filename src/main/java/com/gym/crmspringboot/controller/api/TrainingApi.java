...
public interface TrainingApi {
    ...
    List<TraineeTrainingItemResponse> getTraineeTrainings(String username, LocalDate periodFrom, LocalDate periodTo, String trainerName, String trainingType);

    @Operation(summary = "Get Trainer Trainings", description = "Retrieves a filtered list of trainings for a specific trainer.")
    @ApiResponse(responseCode = "200", description = "Trainings retrieved successfully")
    @ApiResponse(responseCode = "401", description = "Unauthorized")
    List<TrainerTrainingItemResponse> getTrainerTrainings(String username, LocalDate periodFrom, LocalDate periodTo, String traineeName, String trainingType);
    ...
    @ApiResponse(responseCode = "401", description = "Unauthorized")
    void addTraining(AddTrainingRequest trainingDto);
