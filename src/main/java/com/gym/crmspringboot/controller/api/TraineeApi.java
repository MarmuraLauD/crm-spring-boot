...
public interface TraineeApi {
    ...
    TraineeProfileResponse getTraineeProfile(String username, String password);
    ...
    TraineeProfileResponse updateTraineeProfile(String username, String password, UpdateTraineeRequest updateTraineeRequest);
    ...
    List<TrainerItemResponse> updateTraineeTrainers(String username, String password, List<String> trainerUsernames);
}
